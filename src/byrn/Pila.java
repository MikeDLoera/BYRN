...
public class Pila {
     ...
     */
    public void apilar(HashMap valor){
     ...
     * @throws Exception 
     */
    public HashMap cima() throws Exception{
        if(!esVacia()){
    ...
    public boolean buscar(int referencia){
        ...
        while(existe != true && aux != null){
            ...
            if (referencia == Integer.parseInt((String) aux.getValor().get("id"))) {
    ...
    public void remover(int referencia){
        ...
        if (buscar(referencia)) {
            ...
            while(referencia != Integer.parseInt((String) inicio.getValor().get("id"))){
     ...
     */
    public void editar(int referencia, HashMap valor){
